...
/**
 * The BlogCategorys header.
 */
function BlogCategorysHeader() {
	...
	return (
		<div className="flex flex-col sm:flex-row space-y-12 sm:space-y-0 flex-1 w-full justify-between py-32 px-24 md:px-32">
			...
			>
				<Typography className="text-24 md:text-32 font-extrabold tracking-tight">Blog Categories</Typography>
			</motion.span>
...
export default BlogCategorysHeader;
