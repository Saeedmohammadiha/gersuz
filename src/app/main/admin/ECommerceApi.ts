...
export const addTagTypes = ['admin_faqs', 'admin_product', 'admin_orders', 'admin_order'] as const;
export const urls = [
	{getFaqs: ""}
] as const;

export type GetAdminFaqsApiResponse = {
	Id: string;
...
const adminApi = api
	...
	.injectEndpoints({
		endpoints: (build) => ({
			getAdminFaqs: build.query<GetAdminFaqsApiResponse, GetAdminFaqsApiArg>({
